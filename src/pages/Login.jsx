  ...
  try {
    ...
    if (!userSnap.exists()) {
      ...
      const generateReferralCode = () => {
        return "SZE" + Math.random().toString(36).substring(2, 8).toUpperCase();
      };
...
<div className="flex justify-center mt-4">
  <button
     ...
     className="w-14 h-14 rounded-full bg-white flex items-center justify-center shadow-lg active:scale-105 transition"
  >
    <img
